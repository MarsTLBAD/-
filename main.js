...
// @version      1.0.6.1
// @author       【原作者】X.I.U
// @author       【修改增强】MarsTLBAD
// @description  精简多余内容更上一层楼（①隐藏用户头像积分热心值等信息②隐藏用户签名③缩减回帖空白，调整回帖最小高度）
...
(function() {
    ...
    function addStyle() {
        let style,
            ...
            style_2 = `
a[href="connect.php?mod=config"], #toptb, #navmenu, #nv_ph, #nv, #pt .y, #chart, #ft, #custominfo_pmenu, .bm.lk, .dnch_eo_pt, .dnch_eo_pr, .dnch_eo_f,ul.xl.xl2.o.cl, dl.pil.cl, td.plc.plm ,.dnch_eo_pb, .dnch_eo_pt,.pls .avatar img, .pls .side-star, .pls .side-group, .res-footer-note, .scbar_hot_td, .md_ctrl, .pls.favatar .xg1 {
